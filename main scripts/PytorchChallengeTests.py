...
class TestDataset(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.assertNotEqual(csv_path, '', 'Could not locate the reader.csv file')
        self.tab = pd.read_csv(csv_path, sep=';')

    def test_shape(self):
        from model.NNModels.ResNet import ChallengeDataset
...
class TestModel(unittest.TestCase):
    ...
    def test_prediction_after_save_and_load(self):
        ...
        ort_session = onnxruntime.InferenceSession('../assets/checkpoint_test.onnx')
